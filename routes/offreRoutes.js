...
// Routes protegees statiques - doivent etre AVANT /:id pour eviter conflit
...
router.get('/mes-favoris', protect, offreController.getMesFavoris);
...
router.patch('/:offreId/candidatures/:candidatureId', protect, offreController.updateCandidatureStatus);

// Favoris
router.post('/:id/favori', protect, offreController.toggleFavori);
